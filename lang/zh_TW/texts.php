...
$LANG = array(
    ...
    'pro_plan_success' => '感謝您使用 Africa Novatech 的專業版!<p/>&nbsp;<br/>
    ...
    'app_title' => '免費開源的網上發票',
    'app_description' => 'Africa Novatech 是一個免費，開源的發票方案。使用Africa Novatech，你可以從連接網絡的裝置上，容易地建立及傳送美觀的發票。你的客戶可打印你的發票，或是下載為PDF檔，甚至可以從網上付款給你。',
    'rows' => 'rows',
    'www' => 'www',
    'logo' => '標誌',
    'subdomain' => '子網域',
    ...
    'pro_plan_feature4' => '移除 "Created by Africa Novatech" 字樣',
    ...
    'white_label_text' => '購買一年的白牌授權 $:price，從發票和用戶門戶頁面中移除 Africa Novatech 品牌。',
    ...
    'pro_plan_remove_logo' => ':link 來加入專業版，以移除 Africa Novatech 標誌',
    ...
    'pro_plan_year_description' => '訂用 Africa Novatech 專業版一年方案。',
    'pro_plan_month_description' => '訂用 Africa Novatech 專業版一個月方案。',
    'enterprise_plan_product' => '企業方案',
    'enterprise_plan_year_description' => '訂用 Africa Novatech 企業版一年方案。',
    'enterprise_plan_month_description' => '訂用 Africa Novatech 企業版一個月方案。',
...
一旦您收到這兩筆款項，請回到這個付款方式頁面，並點擊帳號旁邊的「完成驗證」。',
    ...
    'export_help' => '若您計畫匯入資料到 Africa Novatech ，請使用JSON。<br/>該檔案包含關於用戶、產品、發票、報價單與付款的資料。',
    ...
    'wepay_account_description' => '於 Africa Novatech 使用的付款閘道',
    ...
    'bot_get_email' => '嗨! (wave)<br/>感謝您試用 Africa Novatech 機器人。<br/>您需建立一個免費帳號以使用這個機器人。<br/>寄給我您的帳號所使用的電子郵件地址，以開始使用它。',
    'bot_get_code' => '感謝! 我已寄給您一封電子郵件，內有您的安全密碼。',
    'bot_welcome' => '好了，您的帳戶已經過驗證。<br/>',
    'email_not_found' => '我無法找到 :email 的可用帳戶',
    'invalid_code' => '密碼不正確',
    'security_code_email_subject' => 'Africa Novatech 機器人的安全密碼',
    'security_code_email_line1' => '這是您的 Africa Novatech 機器人安全密碼。',
    ...
    'warning' => '警告',
    'self-update' => '更新',
    'update_invoiceninja_title' => '更新 Africa Novatech',
    'update_invoiceninja_warning' => '在開始更新 Africa Novatech 之前，先備份您的資料庫與檔案!',
    'update_invoiceninja_available' => '有新版的 Africa Novatech 可用。',
    'update_invoiceninja_unavailable' => 'Africa Novatech 無更新的版本。',
    ...
    'migrate_to_next_version' => '遷移Africa Novatech到下一個版本',
    'migrate_intro_text' => '我們正在準備下一個Africa Novatech的版本。請點擊下載按扭開始遷移。',
    'start_the_migration' => '開始遷移',
    'migration' => '遷移',
    'welcome_to_the_new_version' => '歡迎使用新版本的Africa Novatech',
