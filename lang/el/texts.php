...
<li>"Προκαταβολή πληρωμής για το :QUARTER+1" >> "Προκαταβολή πληρωμής για το Τρίμηνο 2"</li>
    ...
    'email_from' => 'Η Ομάδα του Africa Novatech',
    ...
    'pro_plan_success' => 'Ευχαριστούμε που επιλέξατε το Africa Novatech\'s Pro plan!<p/>&nbsp;<br/>
...
να σας βοηθήσουμε. Στείλτε μας email στο contact@invoiceninja.com\',',
    ...
    'app_description' => 'Africa Novatech is a free, open-source solution for invoicing and billing customers. With Africa Novatech, you can easily build and send beautiful invoices from any device that has access to the web. Your clients can print your invoices, download them as pdf files, and even pay you online from within the system.',
    'rows' => 'γραμμές',
    'www' => 'www',
    'logo' => 'Λογότυπο',
    'subdomain' => 'Υποτομέας',
    ...
    'pro_plan_feature4' => 'Αφαίρεση του "Created by Africa Novatech"',
    ...
    'pro_plan_remove_logo' => ':link για να αφαιρέσετε το λογότυπο Africa Novatech και να συμμετέχετε στο Επαγγελματικό Πλάνο',
    ...
    'pro_plan_year_description' => 'Ένα έτος εγγραφή στο Επαγγελματικό Πλάνο του Africa Novatech.',
    'pro_plan_month_description' => 'Ένας μήνας εγγραφή στο Επαγγελματικό Πλάνο του Africa Novatech.',
    'enterprise_plan_product' => 'Πλάνο Enterprise',
    'enterprise_plan_year_description' => 'Ένα έτος εγγραφή στο Εταιρικό Πλάνο του Africa Novatech.',
    'enterprise_plan_month_description' => 'Ένας μήνας εγγραφή στο Εταιρικό Πλάνο του Africa Novatech.',
    ...
    'export_help' => 'Χρησιμοποιήστε JSON εάν σχεδιάζετε να εισάγετε δεδομένα στο Africa Novatech.<br/>Το αρχείο περιλαμβάνει πελάτες, προϊόντα, τιμολόγια, προσφορές και πληρωμές.',
    ...
    'wepay_account_description' => 'Πύλη Πληρωμών (Gateway) για το Africa Novatech',
    ...
    'bot_get_email' => 'Γειά! (wave)<br/>Ευχαριστώ που δοκιμάσατε τον αυτοματισμό του Africa Novatech.<br/>Θα πρέπει να δημιουργήσετε ένα δωρεάν λογαριασμό για να χρησιμοποιήσετε αυτό τον αυτοματισμό.<br/>Στείλτε μου την διεύθυνση email σας για να ξεκινήσετε.',
    ...
    'security_code_email_subject' => 'Κωδικός ασφαλείας για τον αυτοματισμό Africa Novatech',
    'security_code_email_line1' => 'Αυτός είναι ο κωδικός ασφαλείας για τον αυτοματισμό Africa Novatech',
    ...
    'update_invoiceninja_title' => 'Ενημέρωση Africa Novatech',
    'update_invoiceninja_warning' => 'Πριν αρχίσετε την αναβάθμιση του Africa Novatech, δημιουργήστε ένα αντίγραφο ασφαλείας της βάσης δεδομένων και των αρχείων!',
    'update_invoiceninja_available' => 'Υπάρχει διαθέσιμη νεότερη έκδοση του Africa Novatech.',
    'update_invoiceninja_unavailable' => 'Δεν υπάρχει νεότερη έκδοση του Africa Novatech διαθέσιμη.',
    ...
    'migrate_to_next_version' => 'Μεταφερθείτε στην επόμενη έκδοση του Africa Novatech',
    'migrate_intro_text' => 'Εργαζόμαστε για την επόμενη έκδοση του Africa Novatech. Πατήστε το κουμπί παρακάτω για να ξεκινήσετε τη μεταφορά.',
    'start_the_migration' => 'Ξεκινήστε τη μεταφορά',
    'migration' => 'Μεταφορά',
    'welcome_to_the_new_version' => 'Καλωσήρθατε στην επόμενη έκδοση του Africa Novatech ',
    ...
    'migration_went_wrong' => 'Ουπς, κάτι πήγε λάθος! Σιγουρευτείτε ότι εγκαταστήσατε σωστά μία έκδοση του Africa Novatech v5, πριν ξεκινήσετε τη μεταφορά.',
    ...
    'welcome_to_invoice_ninja' => 'Καλωσήρθατε στο Africa Novatech ',
    'optin' => 'Συμμετοχή',
    'optout' => 'Μη Συμμετοχή',
    ...
    'complete' => 'Ολοκληρωμένη',
     ...
     'application_settings_label' => 'Let\'s store basic information about your Africa Novatech!',
     ...
     'migration_api_secret_notice' => 'You can find API_SECRET in the .env file or Africa Novatech v5. If property is missing, leave field blank.',
    ...
    'migration_already_completed_desc' => 'Looks like you already migrated <b> :company_name </b>to the V5 version of the Africa Novatech. In case you want to start over, you can force migrate to wipe existing data.',
    ...
    'new_login_description' => 'You recently logged in to your Africa Novatech account from a new location or device:<br><br><b>IP:</b> :ip<br><b>Time:</b> :time<br><b>Email:</b> :email',
    ...
    'stripe_connect_migration_desc' => 'Africa Novatech v5 uses Stripe Connect to link your Stripe account to Africa Novatech. This provides an additional layer of security for your account. Now that you data has migrated, you will need to Authorize Stripe to accept payments in v5.<br><br>To do this, navigate to Settings > Online Payments > Configure Gateways. Click on Stripe Connect and then under Settings click Setup Gateway. This will take you to Stripe to authorize Africa Novatech and on your return your account will be successfully linked!',
