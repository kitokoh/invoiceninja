...
',
    ...
    'confirmation_subject' => 'Потвърждаване на Africa Novatech профил',
    ...
    'email_from' => 'Екипът на Africa Novatech',
    ...
    'pro_plan_success' => 'Благодарим Ви, че избрахте Africa Novatech Pro! <p/>&nbsp;<br/>
...
във фактурата, за да платите за една година Pro план<p/>
    ...
    'app_description' => 'Africa Novatech е безплатно решение с отворен код за фактуриране и плащане. С Africa Novatech лесно създавате и изпращате фактури от всяко устройство с достъп до интернет. Клиентите Ви могат да отпечатат фактурите, да ги изтефлят в pdf формат и дори да Ви платят онлайн в системата.',
    'rows' => 'редове',
    'www' => 'www',
    'logo' => 'Лого',
    'subdomain' => 'Subdomain',
    ...
    'pro_plan_feature4' => 'Премахване на "Created by Africa Novatech"',
    ...
    'white_label_text' => 'Купете ЕДНОГОДИШЕН лиценз White label за $:price, за да премахнете брандирането на Africa Novatech от фактурите и клиентския портал.',
    ...
    'pro_plan_remove_logo' => ':link за премахване на логото на Africa Novatech чрез активиране на План Pro',
    ...
    'pro_plan_year_description' => 'Включване за една година в план Africa Novatech Pro.',
    'pro_plan_month_description' => 'Включване за един месец в план Africa Novatech Pro.',
    'enterprise_plan_product' => 'Enterprise Plan',
    'enterprise_plan_year_description' => 'Включване за една година в план Africa Novatech Enterprise.',
    'enterprise_plan_month_description' => 'Включване за един месец в план  Africa Novatech Enterprise.',
    ...
    'export_help' => 'Използвайте JSON ако планирате да импортирате данни в Invoice .<br/>Файлът съдържа клиенти, продукти, фактури, оферти и плащания.',
    ...
    'wepay_account_description' => 'Портал за плащане за Africa Novatech',
    ...
    'bot_get_email' => 'Здравейтеi! (wave)<br/>Благодарим, че тествахте Africa Novatech Bot.<br/>Трябва да създадете безплатен акаунт, за да използвате този bot.<br/>За начало ми изпратете имейл адреса на своя акаунт.',
    ...
    'security_code_email_subject' => 'Код за сигурност за Africa Novatech Bot',
    'security_code_email_line1' => 'Това е Вашият код за сигурност за Africa Novatech Bot.',
    ...
    'update_invoiceninja_title' => 'Актуализиране на Africa Novatech',
    'update_invoiceninja_warning' => 'Преди да стартирате актуализация на Invoice  направете архив на своята база данни и фалове!',
    'update_invoiceninja_available' => 'Налична е нова версия на Invoice .',
    'update_invoiceninja_unavailable' => 'Няма по-нова версия на Invoice .',
    ...
    'migrate_to_next_version' => 'Минете към следващата версия на Africa Novatech',
    'migrate_intro_text' => 'Работим върху следващата версия на Africa Novatech. Щракнете върху бутона по-долу, за да започнете миграцията. ',
    'start_the_migration' => 'Започнете миграцията',
    'migration' => 'Миграция',
    'welcome_to_the_new_version' => 'Добре дошли в новата версия на Africa Novatech',
    ...
    'migration_went_wrong' => 'Упс, нещо не е наред! Моля, уверете се, че сте инсталирали Africa Novatech v5 инстанция преди да стартирате миграцията.',
