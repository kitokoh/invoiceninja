...
 ',
    ...
    'stripe_connect_migration_desc' => 'يستخدم Invoice Ninja v5 Stripe Connect لربط حساب Stripe الخاص بك بـ Invoice . يوفر هذا طبقة إضافية من الأمان لحسابك. الآن بعد أن تم ترحيل بياناتك ، ستحتاج إلى تخويل Stripe لقبول المدفوعات في الإصدار الخامس.<br><br> للقيام بذلك ، انتقل إلى الإعدادات&gt; المدفوعات عبر الإنترنت&gt; تكوين العبارات. انقر فوق Stripe Connect ثم ضمن الإعدادات ، انقر فوق Setup Gateway. سينقلك هذا إلى Stripe لتفويض Invoice Ninja وعند عودتك سيتم ربط حسابك بنجاح!',
