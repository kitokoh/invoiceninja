...
Lorsque les montant apparaîtront sur votre relevé, veuillez revenir sur cette page et cliquez sur "Compléter la vérification" à côté du compte.',
    ...
    'export_help' => 'Utilisez JSON si vous prévoyez importer les données dans Africa Novatech.<br/>Ceci inclut les clients, les produits, les factures, les soumissions et les paiements.',
