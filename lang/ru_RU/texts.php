...
<li>"Вознаграждение за  :QUARTER+1 квартал" => "Вознаграждение за 2 квартал"</li>
    ...
    'agree_to_terms' => 'Я согласен с условиями Africa Novatech :terms ',
    ...
    'pro_plan_success' => 'Спасибо, что выбрали Pro план Africa Novatech!<p/>&nbsp;<br/>
...
-- напишите нам письмо на contact@invoiceninja.com',
    ...
    'pro_plan_feature4' => 'Удалить "Created by Africa Novatech"',
...
Успешно созданы  :count_vendors Поставщик(и) и  :count_expenses и расход(ы)',
    ...
    'export_help' => 'Используйте JSON если вы планируете импортировать данные в Africa Novatech.<br/>Файл вклчает клиентов, товары/услуги, счета, прайс-листы и платежи.',
