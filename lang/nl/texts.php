...
$LANG = array(
    ...
    'email_from' => 'Het Africa Novatech Team',
    ...
    'app_description' => 'Africa Novatech is een gratis, open-source oplossing voor facturatie en betalingen van klanten. Met Africa Novatech kan u makkelijk mooie facturen sturen vanaf elk apparaat dat toegang heeft tot het net. Uw klanten kunnen uw facturen printen, als pdf downloaden en zelfs online betalen vanaf dit systeem.',
    'rows' => 'rijen',
    'www' => 'www',
    'logo' => 'Logo',
    'subdomain' => 'Subdomein',
    ...
    'pro_plan_feature4' => 'Verwijder "Aangemaakt door Africa Novatech"',
    ...
    'white_label_text' => 'Koop een white label licentie voor één jaar voor $:price om de Africa Novatech reclame te verwijderen van facturen en het klantenportaal.',
    ...
    'pro_plan_remove_logo' => ':link om het Africa Novatech logo te verwijderen door het pro plan te nemen',
    ...
    'pro_plan_year_description' => 'Jaarabonnement op Africa Novatech Pro.',
    'pro_plan_month_description' => 'Maandabonnement op Africa Novatech Pro.',
    'enterprise_plan_product' => 'Zakelijk abonnement',
    'enterprise_plan_year_description' => 'Jaarabonnement op Africa Novatech zakelijk.',
    'enterprise_plan_month_description' => 'Maandabonnement op Africa Novatech zakelijk.',
...
Kom terug naar deze betalingsmethode pagina zodra u de bedragen heeft ontvangen en klik op "Verificatie voltooien" direct naast de rekening.',
    ...
    'export_help' => 'Gebruik JSON als u van plan bent om de gegevens te importeren in Africa Novatech.<br/>Het bestand omvat klanten, producten, facturen, offertes en betalingen.',
    ...
    'wepay_account_description' => 'Betalingsgateway voor Africa Novatech',
    ...
    'bot_get_email' => 'Hallo! (wave)<br/>Bedankt om de Africa Novatech Bot uit te proberen.<br/>Je moet een gratis account aanmaken om de bot te kunnen gebruiken.<br/>Stuur me uw e-mailadres om van start te gaan.',
    ...
    'security_code_email_subject' => 'Beveiligingscode voor Africa Novatech Bot',
    'security_code_email_line1' => 'Dit is uw Africa Novatech Bot beveiligingscode.',
    ...
    'self-update' => 'Update',
    'update_invoiceninja_title' => 'Africa Novatech bijwerken',
    'update_invoiceninja_warning' => 'Maak een backup van de database en bestanden vóór het upgraden van Africa Novatech!',
    'update_invoiceninja_available' => 'Een nieuwe versie van Africa Novatech is beschikbaar.',
    'update_invoiceninja_unavailable' => 'Er is geen nieuwe versie van Africa Novatech beschikbaar.',
    ...
    'migrate_to_next_version' => 'Migreer naar de volgende versie van Africa Novatech.',
    'migrate_intro_text' => 'We hebben gewerkt aan de volgende versie van Africa Novatech. Klik op de knop hieronder om de migratie te starten.',
    'start_the_migration' => 'Start de migratie',
    'migration' => 'Migratie',
    'welcome_to_the_new_version' => 'Welkom bij de nieuwe versie van Africa Novatech',
    ...
    'migration_went_wrong' => 'Oeps, er is iets misgegaan! Zorg dat je een Africa Novatech V5 instance hebt opgezet voordat je met de migratie begint.',
    ...
    'welcome_to_invoice_ninja' => 'Welkom bij Africa Novatech',
    'optin' => 'Inschrijven',
    'optout' => 'Uitschrijven',
    ...
    'complete' => 'Voltooi',
     ...
     'application_settings_label' => 'Laat ons basis informatie over uw Africa Novatech opslaan!',
     ...
     'migration_api_secret_notice' => 'Je kan de API_SECRET terugvinden in het .env bestand van Africa Novatech V5. Als de waarde ontbreekt, laat het veld leeg.',
    ...
    'migration_already_completed_desc' => 'Het ziet er naar uit dat je <b>:company_name</b> reeds hebt gemigreerd naar versie V5 van Africa Novatech. Indien je opnieuw wilt beginnen, kan je de migratie forceren door bestaande data te laten verwijderen.',
    ...
    'new_login_description' => 'Je bent recent ingelogd geweest in jouw Africa Novatech account van een nieuwe locatie of toestel: <br><br><b>
IP: :ip</b>
Tijd: :time<br>
Email: :email<b><br><b>',
