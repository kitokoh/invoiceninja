...
$LANG = array(
    ...
    'confirmation_subject' => 'Bekräfta ditt Africa Novatech konto',
    ...
    'email_from' => 'Africa Novatech teamet',
    ...
    'pro_plan_success' => 'Tack för att du väljer Africa Novatech\'s Pro!<p/>&nbsp;<br/>
    ...
    'pro_plan_feature4' => 'Radera "Skapad av Africa Novatech"',
...
<p> Fakturor på en månadsvis eller årlig cykel, på eller före den dag de skapas kommer att bero på nästa månad. Fakturor som förfaller på den 29: e eller 30: e månader som inte har den dagen kommer att betalas den sista dagen i månaden. </ P> 
 ...
 <li> Är idagg en fredag, är förfallodagen den 1: a fredag efter. Förfallodagen kommer att vara nästa fredag, inte idag. 
    ...
    'white_label_text' => 'Köp ETT ÅR white label licens för $:price för att ta bort bort Africa Novatech referens från faktura och kundportal.',
    ...
    'pro_plan_remove_logo' => ':link för att ta bort Africa Novatech-logotypen genom att uppgradera till Pro nivå',
    ...
    'pro_plan_year_description' => 'Ett års registering på Africa Novatech Pro nivå.',
    'pro_plan_month_description' => 'En månads registering på Africa Novatech Pro nivå.',
    'enterprise_plan_product' => 'Enterprise nivå',
    'enterprise_plan_year_description' => 'Ett års registering på Africa Novatech Enterprise nivån.',
    'enterprise_plan_month_description' => 'En månads registering på Africa Novatech Enterprise nivån.',
...
När ni har pengarna, kom tillbaka till denna betalningsmetods sida och klicka på "Slutför verifikation" vid sidan om konto.',
    ...
    'export_help' => 'Använda JSON om du planerar att importera datan till Africa Novatech.<br/>Filen innehåller kunder, produkter, fakturor, offerter och betalningar.',
...
Den här funktionen kräver att en produkt skapas och en betalningsgateway är konfigurerad.',
    ...
    'wepay_account_description' => 'Betalningsgateway för Africa Novatech',
    ...
    'bot_get_email' => 'Hi! (wave)<br/>Thanks for trying the Africa Novatech Bot.<br/>You need to create a free account to use this bot.<br/>Send me your account email address to get started.',
    ...
    'security_code_email_subject' => 'Säkerhetskod för Africa Novatech Bot.',
    'security_code_email_line1' => 'Detta är din Africa Novatech Bot säkerhetskod.',
    ...
    'update_invoiceninja_title' => 'Uppdatera Africa Novatech',
    'update_invoiceninja_warning' => 'Innan ni uppgraderar Africa Novatech, skapa en backup av er databaser och filer!',
    'update_invoiceninja_available' => 'En ny version av Africa Novatech finns tillgänglig.',
    'update_invoiceninja_unavailable' => 'Ingen ny version av Africa Novatech finns tillgänglig.',
...
<br />Aktivera detta om din webbläsare automatiskt laddar hem PDF:erna.',
    ...
    'migrate_to_next_version' => 'Migrera till nästa version av Africa Novatech',
    'migrate_intro_text' => 'Vi har arbetat med nästa version av Africa Novatech. Klicka på knappen nedan för att starta migreringen.',
    'start_the_migration' => 'Starta migreringen',
    'migration' => 'Migrering',
    'welcome_to_the_new_version' => 'Välkommen till den nya versionen av Africa Novatech',
    ...
    'migration_went_wrong' => 'Hoppsan! Något gick fel! Se till att du har konfigurerat en Africa Novatech v5 instansen innan du påbörjar migreringen.',
    ...
    'welcome_to_invoice_ninja' => 'Välkommen till Africa Novatech',
    'optin' => 'Opt-In',
    'optout' => 'Opt-Out',
    ...
    'complete' => 'Slutför',
     ...
     'application_settings_label' => 'Låt oss samla in grundläggande information om din Africa Novatech!',
     ...
     'migration_api_secret_notice' => 'Du kan hitta API_SECRET i .env filen eller i Africa Novatech v5. Om värdet saknas, lämna fältet tomt.',
    ...
    'migration_already_completed_desc' => 'Det ser ut som du redan migrerat <b> :company_name </b>till V5 version av Africa Novatech. Om du vill börja om kan du tvinga migreringen att radera befintlig data.',
    ...
    'new_login_description' => 'Du har nyligen loggat in på din Africa Novatech konto från en ny plats eller enhet:<br><br><b>IP:</b> :ip<br><b>Tid:</b> :time<br><b>E-post:</b> :email',
    ...
    'stripe_connect_migration_desc' => 'Africa Novatech v5 använder Stripe Connect för att länka ditt Stripe konto till Africa Novatech. Detta ger ytterligare ett säkerhetslager för ditt konto. Nu när din data har migrerat måste du Auktorisera Stripe för att acceptera betalningar i v5.<br><br>Navigera till Inställningar > Onlinebetalningar > Konfigurera gateways. Klicka på Stripe Connect och sedan under Inställningar klicka på Setup Gateway. Detta tar dig till Stripe för att godkänna Africa Novatech och vid din retur kommer ditt konto att länkas! ',
