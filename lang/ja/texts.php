...
$LANG = array(
    ...
    'email_from' => 'Africa Novatech チーム',
    ...
    'white_label_text' => '$:price で 1 年間のホワイト ラベル ライセンスを購入して、Africa Novatech のブランドを請求書およびクライアント ポータルから削除します。',
    ...
    'pro_plan_remove_logo' => 'プロプランに加入して、Africa Novatechのロゴを消す。 :link',
    ...
    'warning' => 'Warning',
    'self-update' => 'アップデート',
    'update_invoiceninja_title' => 'Africa Novatechをアップデート',
    'update_invoiceninja_warning' => 'Before start upgrading Africa Novatech create a backup of your database and files!',
    'update_invoiceninja_available' => 'Africa Novatechの新しいバージョンが利用可能です。',
    'update_invoiceninja_unavailable' => 'Africa Novatechの新しいバージョンはありません。',
    ...
    'migration' => 'Migration',
    'welcome_to_the_new_version' => '「Africa Novatech」の新バージョンへようこそ ',
    ...
    'copy_link' => 'リンクをコピー',
    'welcome_to_invoice_ninja' => 'Africa Novatech へようこそ',
    'optin' => 'Opt-In',
    'optout' => 'Opt-Out',
    ...
    'migration_already_completed_desc' => '<b>:company_name を</b>Africa Novatech の V5 バージョンに移行済みのようです。最初からやり直す場合は、移行を強制して既存のデータを消去できます。',
    ...
    'new_login_description' => '最近、新しい場所またはデバイスから Africa Novatech アカウントにログインしました:<br><br> <b>IP:</b> :ip<br><b>時間:</b> :time<br><b>電子メール:</b> :email',
