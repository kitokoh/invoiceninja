...
<li>"Pagamento de retentor para :QUARTER+1" >> "Pagamento de retentor para 3T"</li>
    ...
    'email_from' => 'Equipa Africa Novatech',
    ...
    'pro_plan_success' => 'Obrigado por escolher o Plano Profissional do Africa Novatech! <p/>&nbsp;<br/>
...
-- envie-nos um email para contact@invoiceninja.com',
    ...
    'app_description' => 'Africa Novatech é uma solução de faturação e pagamento gratuita e open-source. Com Africa Novatech, consegue facilmente construir e enviar notas de pagamento apelativas a partir de qualquer dispositivo com acesso à internet. Os seus clientes podem imprimir as notas de pagamento, transferi-las como ficheiros PDF e ainda pagar através da internet.',
    'rows' => 'linhas',
    'www' => 'www',
    'logo' => 'Logótipo',
    ...
    'pro_plan_feature4' => 'Remover "Created by Africa Novatech"',
    ...
    'white_label_text' => 'Comprar UM ANO da licença de marca branca por $:price para remover a marca do Africa Novatech das notas de pagamento e do portal do cliente.',
    ...
    'pro_plan_remove_logo' => ':link para remover a logo do Africa Novatech adquirindo o plano profissional',
    ...
    'pro_plan_year_description' => 'Subscrição de um ano no plano Africa Novatech Profissional.',
    'pro_plan_month_description' => 'Um mês de subscrição no plano Africa Novatech Profissional.',
    'enterprise_plan_product' => 'Plano Empresa',
    'enterprise_plan_year_description' => 'Um ano de subscrição no plano Africa Novatech Empresa.',
    'enterprise_plan_month_description' => 'Um mês de subscrição no plano Africa Novatech Empresa.',
...
Quando tiver os valores dos depósitos, volte a esta página e conclua a verificação da sua conta.',
    ...
    'export_help' => 'Utilize JSON se planear importar os dados para o Africa Novatech.<br/>O ficheiro incluí clientes, produtos, notas de pagamento, orçamentos e pagamentos.',
    ...
    'wepay_account_description' => 'Portal de pagamento para o Africa Novatech',
 ...
 €0.25) por pagamento realizado.',
    ...
    'bot_get_email' => 'Olá! (wave) Obrigado por experimentares o bot da Africa Novatech.É necessário criar uma conta para poder utilizar este bot. Introduz o teu endereço de e-mail para começar.',
    ...
    'security_code_email_subject' => 'Código de segurança para o Africa Novatech Bot',
    'security_code_email_line1' => 'Este é o seu código de segurança para o Africa Novatech Bot.',
    ...
    'update_invoiceninja_title' => 'Atualizar Africa Novatech',
    'update_invoiceninja_warning' => 'Antes de começar a atualizar o Africa Novatech crie uma cópia de segurança da sua base de dados e ficheiros!',
    'update_invoiceninja_available' => 'Uma nova versão do Africa Novatech está disponível.',
    'update_invoiceninja_unavailable' => 'Não existe uma versão mais recente do Africa Novatech.',
...
debitar da sua conta de acordo com essas instruções. Está elegível a um reembolso desse mesmo débito sob os termos e condições acordados entre si e o banco. O reembolso deve ser pedido nas 8 (oito) semanas seguintes a partir da data do débito.',
    ...
    'migrate_to_next_version' => 'Migrar para a próxima versão do Africa Novatech',
    'migrate_intro_text' => 'Estamos a trabalhar na nova versão do Africa Novatech. Clique no botão abaixo para iniciar a migração.',
    'start_the_migration' => 'Começar migração',
    'migration' => 'Migração',
    'welcome_to_the_new_version' => 'Bem-vindo à nova versão do Africa Novatech',
    ...
    'migration_went_wrong' => 'Ups, alguma coisa não correu bem! Certifique-se de configurar uma instância do Africa Novatech v5 antes de iniciar a migração.',
    ...
    'welcome_to_invoice_ninja' => 'Bem-vindo ao Africa Novatech',
    'optin' => 'Autorizar',
    'optout' => 'Desautorizar',
    ...
    'complete' => 'Completo',
     ...
     'migration_api_secret_notice' => 'Você pode encontrar API_SECRET no arquivo .env ou Africa Novatech v5. Se a propriedade estiver ausente, deixe o campo em branco.',
    ...
    'migration_already_completed_desc' => 'Parece que já houve uma migração da :company_name para a versão V5 do Africa Novatech. Caso queria redefinir tudo e recomeçar, pode forçar a migração para limpar os dados existentes.',
    ...
    'new_login_description' => 'Você entrou recentemente na sua conta Africa Novatech de uma nova localização ou dispositivo:<br><br><b>IP:</b> :ip<br><b>Hora:</b> :time<br><b>E-mail:</b> :email',
    ...
    'stripe_connect_migration_desc' => 'O Africa Novatech v5 usa o Stripe Connect para vincular sua conta Stripe ao Africa Novatech. Isso fornece uma camada adicional de segurança para sua conta. Agora que seus dados foram migrados, você precisará Autorizar o Stripe para aceitar pagamentos na v5.<br><br> Para fazer isso, navegue até Configurações &gt; Pagamentos online &gt; Configurar gateways. Clique em Stripe Connect e, em Configurações, clique em Configurar Gateway. Isso levará você ao Stripe para autorizar o Africa Novatech e, ao retornar, sua conta será vinculada com sucesso!',
