...
',
    ...
    'pro_plan_success' => 'Danke, dass Sie Africa Novatech\'s Pro-Tarif gewählt haben!<p/>&nbsp;<br/>
    ...
    'pro_plan_feature4' => '"Erstellt durch Africa Novatech" entfernen',
...
<li>Heute ist Freitag, das Fälligkeitsdatum ist der Freitag einer jeden Woche. Das nächste Fälligkeitsdatum entspricht dem nächsten Freitag, also nicht heute.
    ...
    'white_label_text' => 'Kaufen Sie eine Ein-Jahres-"White Label"-Lizenz für $:price um das Africa Novatech Branding von den Rechnungen und dem Kundenportal zu entfernen.',
    ...
    'pro_plan_year_description' => 'Einjährige Registrierung für den Africa Novatech Pro-Plan.',
    'pro_plan_month_description' => 'Einmonatliche Registrierung für den Africa Novatech Pro-Plan.',
    'enterprise_plan_product' => 'Unternehmensplan',
    'enterprise_plan_year_description' => 'Einjährige Registrierung für den Africa Novatech Enterprise-Plan.',
    'enterprise_plan_month_description' => 'Einmonatliche Registrierung für den Africa Novatech Enterprise-Plan.',
...
Sobald Sie die Beträge erhalten haben, kommen Sie bitte wieder zurück zu dieser Zahlungsmethoden-Seite und klicken Sie auf "Complete Verification" neben Ihrem Konto.',
    ...
    'export_help' => 'Nutzen Sie JSON wenn Sie die Daten in Africa Novatech importieren wollen.<br/>Die Datei beinhaltet Kunden, Produkte, Rechnungen, Angebote und Zahlungen.',
    ...
    'wepay_account_description' => 'Zahlungs-Gateway für Africa Novatech',
    ...
    'security_code_email_subject' => 'Sicherheitscode für Africa Novatech Bot',
    'security_code_email_line1' => 'Dies ist Ihr Africa Novatech Bot Sicherheitscode.',
    ...
    'update_invoiceninja_warning' => 'Vor dem Update von Africa Novatech sollte ein Sicherungskopie der Datenbank und der Dateien erstellt werden!',
    'update_invoiceninja_available' => 'Eine neue Version von Africa Novatech ist verfügbar.',
    'update_invoiceninja_unavailable' => 'Keine neue Version von Africa Novatech verfügbar.',
    ...
    'migrate_to_next_version' => 'Zur nächsten Version von Africa Novatech migrieren',
    'migrate_intro_text' => 'Wir haben an der nächsten Africa Novatech Version gearbeitet. Klicke auf den Button unten um die Migration auf die neue Version zu starten.',
    'start_the_migration' => 'Starte die Migration',
    'migration' => 'Migration',
    'welcome_to_the_new_version' => 'Herzlich willkommen zur neuen Version von Africa Novatech',
...
https://invoiceninja.github.io/docs/migration/#troubleshooting',
    ...
    'welcome_to_invoice_ninja' => 'Willkommen bei Africa Novatech',
    'optin' => 'Anmelden',
    'optout' => 'Abmelden',
    ...
    'complete' => 'Fertigstellen',
     ...
     'application_settings_label' => 'Lassen Sie uns grundlegende Informationen über Ihr Africa Novatech speichern!',
     ...
     'migration_api_secret_notice' => 'Sie finden API_SECRET in der .env-Datei oder in Africa Novatech v5. Wenn die Eigenschaft fehlt, lassen Sie das Feld leer.',
    ...
    'migration_already_completed_desc' => 'Anscheinend haben Sie :company_name bereits auf die V5-Version von Africa Novatech migriert. Falls Sie von vorne beginnen möchten, können Sie die Migration erzwingen, um vorhandene Daten zu löschen.',
    ...
    'new_login_description' => 'Sie haben sich kürzlich von einem neuen Standort oder Gerät aus bei Ihrem Africa Novatech-Konto angemeldet: <br><br><b>IP:</b> :ip<br><b>Time: </b>:time<br> Email: <b> :email',
    ...
    'stripe_connect_migration_desc' => 'Verbinden Sie Ihre Rechnung Ninja v5 verwendet Stripe Connect, um Ihr Stripe-Konto mit Africa Novatech zu verbinden. Dies bietet eine zusätzliche Sicherheitsebene für Ihr Konto. Nachdem Ihre Daten migriert wurden, müssen Sie Stripe autorisieren, Zahlungen in v5 zu akzeptieren. <br><br>Navigieren Sie dazu zu Einstellungen > Online-Zahlungen > Gateways konfigurieren. Klicken Sie auf Stripe Connect und dann unter Einstellungen auf Gateway einrichten. Dadurch werden Sie zu Stripe weitergeleitet, um Africa Novatech zu autorisieren, und bei Ihrer Rückkehr wird Ihr Konto erfolgreich verknüpft sein!',
