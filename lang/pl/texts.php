...
"Płatne z góry za kwartał :QUARTER+1" >> "Płatne z góry za kwartał Q2"',
    ...
    'email_from' => 'Zespół The Africa Novatech',
    ...
    'app_description' => 'Africa Novatech to darmowe rozwiązanie typu open source do wystawiania faktur i rozliczania klientów. Dzięki Africa Novatech możesz łatwo przygotować i wysłać piękne faktury za pomocą dowolnego urządzenia, z którego masz dostęp do sieci. Twoi klienci mogą drukować te faktury, pobierać je w postaci plików PDF i opłacać je za pomocą systemu płatności online.',
    'rows' => 'wierszy',
    'www' => 'www',
    'logo' => 'Logo',
    'subdomain' => 'Subdomena',
    ...
    'white_label_text' => 'Kup roczną licencję white label za $:price, aby usunąć wzmianki o Africa Novatech z faktur i portalu klienta.',
...
Gdy przelewy zostaną zaksięgowane na Twoim koncie, wróć do tej strony i kliknij "Dokończ weryfikację" obok właściwego konta.',
    ...
    'export_help' => 'Użyj formatu JSON, jeśli planujesz zaimportować dane do Africa Novatech.<br/> Taki plik zawiera dane klientów, produkty, faktury, oferty i płatności.',
    ...
    'wepay_account_description' => 'Dostawca płatności dla Africa Novatech',
    ...
    'security_code_email_subject' => 'Kod bezpieczeństwa dla Africa Novatech Bot',
    'security_code_email_line1' => 'Oto Twój kod bezpieczeństwa Bota Africa Novatech.',
    ...
    'update_invoiceninja_title' => 'Zaktualizuj Africa Novatech',
    'update_invoiceninja_warning' => 'Przed przejściem na nową wersję Africa Novatech stwórz kopię bezpieczeństwa swojej bazy danych i plików.',
    'update_invoiceninja_available' => 'Nowa wersja Africa Novatech jest dostępna.',
    'update_invoiceninja_unavailable' => 'Nowa wersja Africa Novatech nie jest dostępna.',
    ...
    'migration' => 'Migracja',
    'welcome_to_the_new_version' => 'Witamy w nowej wersji Africa Novatech',
    ...
    'new_login_description' => 'Ostanie logowania do Twojego konta Africa Novatech z nowej lokalizacji lub urządzenia:<br><br><b>IP:</b> :ip<br><b>Czas:</b> :time<br><b>Email:</b> :email',
