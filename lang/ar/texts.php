...
$LANG = array(
    ...
    'email_from' => 'فريق Africa Novatech',
    ...
    'pro_plan_success' => 'شكرًا لاختيارك خطة Africa Novatech&#39;s Pro!<p/ style=";text-align:right;direction:rtl"><br/> <b>الخطوات التالية</b><p/ style=";text-align:right;direction:rtl"> تم إرسال فاتورة مستحقة الدفع إلى عنوان البريد الإلكتروني المرتبط بحسابك. لإلغاء تأمين جميع ميزات Pro الرائعة ، يرجى اتباع الإرشادات الموجودة على الفاتورة لدفع رسوم عام من الفواتير على مستوى Pro.<p/ style=";text-align:right;direction:rtl"> لا يمكنك العثور على الفاتورة؟ هل تحتاج إلى مزيد من المساعدة؟ يسعدنا تقديم المساعدة - راسلنا عبر البريد الإلكتروني على contact@invoiceninja.com',
    ...
    'app_description' => 'Africa Novatech هو حل مجاني مفتوح المصدر لعمل الفواتير . باستخدام Africa Novatech ، يمكنك بسهولة إنشاء وإرسال فواتير جميلة من أي جهاز يمكنه الوصول إلى الويب. يمكن لعملائك طباعة فواتيرك وتنزيلها كملفات pdf وحتى الدفع لك عبر الإنترنت من داخل النظام.',
    'rows' => 'صفوف',
    'www' => 'www',
    'logo' => 'شعار',
    ...
    'pro_plan_feature4' => 'إزالة &quot;Created by Africa Novatech&quot;',
    ...
    'white_label_text' => 'قم بشراء ترخيص بطاقة بيضاء لمدة عام واحد مقابل $: السعر لإزالة علامة Africa Novatech التجارية من الفاتورة وبوابة العميل.',
    ...
    'pro_plan_remove_logo' => ':link لإزالة شعار Africa Novatech من خلال الانضمام إلى خطة Pro',
    ...
    'pro_plan_year_description' => 'التسجيل لمدة عام في Africa Novatech Pro Plan.',
    'pro_plan_month_description' => 'التسجيل لمدة شهر واحد في Africa Novatech Pro Plan.',
    'enterprise_plan_product' => 'خطة المؤسسة',
    'enterprise_plan_year_description' => 'التسجيل لمدة عام واحد في Africa Novatech Enterprise Plan.',
    'enterprise_plan_month_description' => 'التسجيل لمدة شهر واحد في Africa Novatech Enterprise Plan.',
    ...
    'export_help' => 'استخدم JSON إذا كنت تخطط لاستيراد البيانات إلى Invoice .<br/> يتضمن الملف العملاء والمنتجات والفواتير وعروض الأسعار والمدفوعات.',
...
 ',
    ...
    'bot_get_email' => 'أهلاً! (موجة)<br/> نشكرك على تجربة Africa Novatech Bot.<br/> تحتاج إلى إنشاء حساب مجاني لاستخدام هذا الروبوت.<br/> أرسل لي عنوان البريد الإلكتروني لحسابك للبدء.',
    ...
    'security_code_email_subject' => 'رمز الحماية لـ Africa Novatech Bot',
    'security_code_email_line1' => 'هذا هو رمز أمان Africa Novatech Bot الخاص بك.',
    ...
    'update_invoiceninja_warning' => 'قبل البدء في ترقية Africa Novatech ، قم بإنشاء نسخة احتياطية من قاعدة البيانات والملفات الخاصة بك!',
    'update_invoiceninja_available' => 'يتوفر إصدار جديد من Invoice .',
    'update_invoiceninja_unavailable' => 'لا يتوفر إصدار جديد من Invoice .',
    ...
    'migrate_to_next_version' => 'الانتقال إلى الإصدار التالي من Africa Novatech',
    'migrate_intro_text' => 'نحن نعمل على الإصدار التالي من Invoice  . اضغط الزر في الأسفل لبدء المزامنة.',
    'start_the_migration' => 'ابدأ الدمج',
    'migration' => 'الهجرة',
    'welcome_to_the_new_version' => 'مرحبًا بك في الإصدار الجديد من Africa Novatech',
    ...
    'migration_went_wrong' => 'تبا شيء ما حدث بشكل خاطئ! يرجى التأكد من إعداد مثيل Africa Novatech v5 قبل بدء الترحيل.',
    ...
    'welcome_to_invoice_ninja' => 'أهلا بك في Africa Novatech',
    'optin' => 'اشتراك',
    'optout' => 'إلغاء اشتراك',
    ...
    'complete' => 'إنهاء',
     ...
     'api_secret' => 'سر API',
     'migration_api_secret_notice' => 'يمكنك العثور على API_SECRET في ملف .env أو Africa Novatech v5. إذا كانت الخاصية مفقودة ، اترك الحقل فارغًا.',
    ...
    'new_login_description' => 'لقد قمت مؤخرًا بتسجيل الدخول إلى حساب Africa Novatech الخاص بك من موقع أو جهاز جديد:<br><br> <b>IP:</b> :ip<br> <b>الوقت:</b> :time<br> <b>البريد الإلكتروني:</b> :email',
    ...
    'stripe_connect_migration_desc' => 'يستخدم Africa Novatech v5 Stripe Connect لربط حساب Stripe الخاص بك بـ Invoice . يوفر هذا طبقة إضافية من الأمان لحسابك. الآن بعد أن تم ترحيل بياناتك ، ستحتاج إلى تخويل Stripe لقبول المدفوعات في الإصدار الخامس.<br><br> للقيام بذلك ، انتقل إلى الإعدادات&gt; المدفوعات عبر الإنترنت&gt; تكوين العبارات. انقر فوق Stripe Connect ثم ضمن الإعدادات ، انقر فوق Setup Gateway. سينقلك هذا إلى Stripe لتفويض Africa Novatech وعند عودتك سيتم ربط حسابك بنجاح!',
