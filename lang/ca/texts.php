...
<li>"Pagament consultor del :QUARTER+1" >> "Pagament consultor del Q2"</li>
    ...
    'migrate_intro_text' => 'We\'ve been working on next version of Invoice . Click the button bellow to start the migration.',
