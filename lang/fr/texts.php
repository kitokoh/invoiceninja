...
$LANG = array(
    ...
    'email_from' => 'L’équipe Africa Novatech',
    ...
    'pro_plan_feature4' => 'Retirer "Created by Africa Novatech"',
    ...
    'white_label_text' => 'Achetez une licence en marque blanche d\'UN AN au coût de $:price pour retirer la marque de Africa Novatech des factures et du portail client.',
    ...
    'pro_plan_remove_logo' => ':link pour supprimer le logo Africa Novatech en souscrivant au Plan Pro',
    ...
    'pro_plan_year_description' => 'Engagement d\'un an dans le Plan Africa Novatech Pro.',
    'pro_plan_month_description' => 'Engagement d\'un mois dans le Plan Africa Novatech Pro.',
    'enterprise_plan_product' => 'Plan Entreprise',
    'enterprise_plan_year_description' => 'Engagement d\'un an dans le Plan Africa Novatech Entreprise.',
    'enterprise_plan_month_description' => 'Engagement d\'un mois dans le Plan Africa Novatech Entreprise.',
...
Lorsque les montant apparaîtront sur votre relevé, veuillez revenir sur cette page et cliquez sur "Compléter la vérification" à côté du compte.',
    ...
    'export_help' => 'Utilisez JSON si vous prévoyez d\'importer des données dans Africa Novatech.<br/>Le fichier inclut les clients, les produits, les factures, les offres et les paiements.',
    ...
    'wepay_account_description' => 'Passerelle de paiement pour Africa Novatech',
    ...
    'bot_get_email' => 'Salut! (wave)<br/>Merci d\'essayer le Bot Africa Novatech.<br/>Vous devez créer un compte gratuit pour utiliser ce bot.<br/>Envoyez-moi l\'adresse courriel de votre compte pour commencer.',
    ...
    'security_code_email_subject' => 'Code de sécurité pour le Bot de Africa Novatech',
    'security_code_email_line1' => 'Ceci est votre code de sécurité pour le Bot de Africa Novatech.',
    ...
    'update_invoiceninja_title' => 'Mettre à jour Africa Novatech',
    'update_invoiceninja_warning' => 'Avant de commencer une mise à jour d\'Africa Novatech, créez une sauvegarde de votre base de données et de vos fichiers!',
    'update_invoiceninja_available' => 'Une nouvelle version de Africa Novatech est disponible.',
    'update_invoiceninja_unavailable' => 'Aucune mise à jour de Africa Novatech disponible.',
    ...
    'migrate_to_next_version' => 'Migrer dans la nouvelle version d\'Africa Novatech.',
    'migrate_intro_text' => 'Nous avons travaillé sur une nouvelle version de Africa Novatech. Cliquez sur le bouton ci-dessous pour démarrer la migration.',
    'start_the_migration' => 'Démarrer la migration',
    'migration' => 'Migration',
    'welcome_to_the_new_version' => 'Bienvenue dans la nouvelle version d\'Africa Novatech',
    ...
    'migration_went_wrong' => 'Oups, quelque chose n\'a pas bien fonctionné ! Veuillez vous assurer que vous avez bien configuré une instance d\'Africa Novatech v5 avant de commencer la migration.',
    ...
    'welcome_to_invoice_ninja' => 'Bienvenue sur Africa Novatech',
    'optin' => 'Adhésion',
    'optout' => 'Désadhésion',
    ...
    'complete' => 'Complet',
     ...
     'application_settings_label' => 'Stockons les informations de base sur votre Africa Novatech !',
     ...
     'migration_api_secret_notice' => 'Vous pouvez trouver API_SECRET dans le fichier .env ou dans Africa Novatech v5. Si la propriété est manquante, laissez le champ vide.',
    ...
    'migration_already_completed_desc' => 'Il semble que vous ayez déjà migré <b> :company_name </b> vers la version V5 d\'Africa Novatech. Si vous souhaitez recommencer, vous pouvez forcer la migration pour effacer les données existantes.',
    ...
    'new_login_description' => 'Vous vous êtes récemment connecté à votre compte Africa Novatech à partir d\'un nouvel emplacement ou d\'un nouvel appareil :<br><br><b>IP:</b> :Heure:</b> :time<br><b>Courriel:</b> :email',
    ...
    'stripe_connect_migration_desc' => 'Africa Novatech v5 utilise Stripe Connect pour lier votre compte Stripe à Africa Novatech. Cela fournit une couche de sécurité supplémentaire pour votre compte. Maintenant que vos données ont migré, vous devrez autoriser Stripe à accepter les paiements dans la v5. <br> <br> Pour ce faire, accédez à Paramètres > Paiements en ligne > Configurer les passerelles. Cliquez sur Stripe Connect, puis sous Paramètres, cliquez sur Configurer la passerelle. Cela vous amènera à Stripe pour autoriser Africa Novatech et à votre retour, votre compte sera lié avec succès !',
