...
<p>Dünaamiliste kuupäevade jaoks kasutage :KUU, :KVARTAL või :AASTA. Ka elementaarne matemaatika töötab, näiteks :KUU-1.</p>
 ...
 <li>"Kinnipidamistasu KVARTAL+1 eest" >> "Teise kvartali kinnipidamistasu"
    ...
    'email_from' => 'Africa Novatech Meeskond',
    ...
    'pro_plan_success' => 'Täname, et valisite Africa Novatech Pro paketi!<p/>&nbsp;<br/>
 ...
 Kas te ei leidnud arvet? Kas vajate täiendavat abi? Meil on hea meel aidata -- saatke meile e-kiri aadressil contact@invoiceninja.com',
    ...
    'app_description' => 'Africa Novatech on tasuta ja avatud lähtekoodiga lahendus klientidele arvete genereerimiseks ja saatmiseks. Africa Novatech abil saate hõlpsalt ilusaid arveid koostada ja saata mis tahes seadmest. Vajalik on vaid interneti olemasolu Teie kliendid saavad teie arveid printida, pdf-failidena alla laadida ja isegi makselahenduse kaudu otse maksta.',
    'rows' => 'rida',
    'www' => 'www',
    'logo' => 'Logo',
...
<p>Kuu- või aastatsükli arved, mille maksetähtaeg on koostamise päeval või enne seda, tuleb tasuda järgmisel kuul. Arved, mille maksetähtaeg on 29. või 30. kuu jooksul, millel seda päeva pole, tuleb tasuda kuu viimasel päeval.</p>
 ...
 <li>Täna on reede, tähtaeg on 1. reede pärast seda. Tähtaeg on järgmisel reedel, mitte täna.
    ...
    'pro_plan_remove_logo' => ':link Africa Novatech logo eemaldamiseks, liitudes Pro-paketiga',
    ...
    'pro_plan_year_description' => 'Üheaastane registreerumine Africa Novatech Pro paketiga.',
    'pro_plan_month_description' => 'Ühekuuline registreerumine Africa Novatech Pro paketiga.',
    'enterprise_plan_product' => 'Ettevõtlusplaan',
    'enterprise_plan_year_description' => 'Üheaastane registreerumine Africa Novatech ettevõtlusplaaniga.',
    'enterprise_plan_month_description' => 'Ühekuuline registreerumine Africa Novatech ettevõtlusplaaniga.',
    ...
    'export_help' => 'Kasuta JSON vormingut kui soovind andmed importida Africa Novatech-sse.<br/>Fail sisaldab kliente, tooteid, arveid, pakkumusi ja makseid.',
    ...
    'bot_get_email' => 'Tere! (lehvitus)<br/>Täname Africa Novatech Boti proovimise eest.<br/>Selle boti kasutamiseks peate looma tasuta konto.<br/>Alustamiseks saatke mulle oma konto meiliaadress.',
    ...
    'security_code_email_line1' => 'See on teie Africa Novatech Boti turvakood.',
...
 ',
    ...
    'update_invoiceninja_warning' => 'Enne Africa Novatech versiooniuuenduse alustamist looge oma andmebaasist ja failidest varukoopia!',
    'update_invoiceninja_available' => 'Africa Novatech uus versioon on saadaval.',
    'update_invoiceninja_unavailable' => 'Africa Novatech uut versiooni pole saadaval.',
    ...
    'migration' => 'Migration',
    'welcome_to_the_new_version' => 'Tere tulemast Africa Novatech uude versiooni',
    ...
    'migration_went_wrong' => 'Oops! Midagi läks valesti! Enne üleviimise alustamist veenduge, et oleksite seadistanud Africa Novatech v5 eksemplari.',
    ...
    'welcome_to_invoice_ninja' => 'Tere tulemast Africa Novatechsse',
    'optin' => 'Opt-In',
    'optout' => 'Opt-Out',
    ...
    'new_login_description' => 'Logisite hiljuti oma Africa Novatech kontole sisse uuest asukohast või seadmest:<br><br><b>IP:</b> :ip<br><b>Aeg:</b> : time<br><b>E-post:</b> :email',
