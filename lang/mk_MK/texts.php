...
<li> "Задржано плаќање за :QUARTER+1" >> "Задржано плаќање за К2" </li>
    ...
    'email_from' => 'Тимот на Africa Novatech',
    ...
    'pro_plan_success' => 'Ви благодариме што го избравте Про планот на Africa Novatech! <p/> &nbsp; <br/>
 ...
 --пратете ни е-пошта на contact@invoiceninja.com',
    ...
    'pro_plan_feature4' => 'Отстрани "Креирано со Africa Novatech"',
 ...
 <li> Денес е петок, датумот на достасување е првиот петок потоа. Датумот на достасување би бил наредниот петок, не денес. 
    ...
    'white_label_text' => 'Купете ЕДНОГОДИШЕН ПЛАН за брендирана лиценца за $:price за да го отстраните брендирањето на Africa Novatech од клиентскиот портал.',
    ...
    'pro_plan_remove_logo' => ':link за отстранување на Africa Novatech логото со приклучување на Pro планот',
    ...
    'pro_plan_year_description' => 'Една година запишување на Africa Novatech Pro планот.',
    'pro_plan_month_description' => 'Еден месец запишување на Africa Novatech Pro планот.',
    'enterprise_plan_product' => 'План за претпријатие',
    'enterprise_plan_year_description' => 'Една година запишување на Africa Novatech Pro планот за претпријатие.',
    'enterprise_plan_month_description' => 'Еден месец запишување на Africa Novatech Pro планот за претпријатие.',
...
Откако ќе ги добиете износите, вратете се на оваа страница за начин на плаќање и кликнете "Заврши Верификација" до сметката.',
    ...
    'export_help' => 'Користи JSON ако планираш да ги внесеш информациите во Africa Novatech. <br/> Датотеката содржи клиенти, продукти, фактури, понуди и плаќања.',
    ...
    'wepay_account_description' => 'Платен портал за Africa Novatech',
    ...
    'bot_get_email' => 'Здраво! (wave) <br/> Ви благодарам што го пробавте Africa Novatech ботот. <br/> Треба да креирате бесплатна сметка за да го користите овој бот. <br/> Испратете ми ја адресата на вашата е-пошта со која е поврзана сметката за да започнеме.',
    ...
    'security_code_email_subject' => 'Сигурносен код за Africa Novatech ботот',
    'security_code_email_line1' => 'Ова е вашиот Africa Novatech Bot сигурносен код.',
    ...
    'update_invoiceninja_title' => 'Ажурирај Africa Novatech',
    'update_invoiceninja_warning' => 'Пред за започнете со ажурирање на Africa Novatech креирајте бекап на вашата датабаза и датотеки.',
    'update_invoiceninja_available' => 'Достапна е нова верзија на Africa Novatech.',
    'update_invoiceninja_unavailable' => 'Нема достапна нова верзија на Africa Novatech.',
    ...
    'migrate_to_next_version' => 'Migrate to the next version of Africa Novatech',
    'migrate_intro_text' => 'We\'ve been working on next version of Africa Novatech. Click the button bellow to start the migration.',
    'start_the_migration' => 'Start the migration',
    'migration' => 'Migration',
    'welcome_to_the_new_version' => 'Welcome to the new version of Africa Novatech',
    ...
    'migration_went_wrong' => 'Oops, something went wrong! Please make sure you have setup an Africa Novatech v5 instance before starting the migration.',
    ...
    'copy_link' => 'Copy Link',
    'welcome_to_invoice_ninja' => 'Welcome to Africa Novatech',
    'optin' => 'Opt-In',
    'optout' => 'Opt-Out',
