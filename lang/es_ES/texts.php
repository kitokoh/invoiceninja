...
$LANG = array(
    ...
    'email_from' => 'El equipo de Africa Novatech ',
    ...
    'pro_plan_success' => '¡Gracias por unirte a Africa Novatech! Al realizar el Pago de tu Factura, se iniciara tu PLAN PRO.',
    ...
    'invitation_message' => ':invitor te ha invitado a unirte a su cuenta en Africa Novatech.',
    ...
    'app_description' => 'Africa Novatech es una solución open-source gratuita para manejar la facturación de tus clientes. Con Africa Novatech, se pueden crear y enviar hermosas facturas desde cualquier dispositivo que tenga acceso a Internet. Tus clientes pueden imprimir tus facturas, descargarlas en formato PDF o incluso pagarlas en linea desde esta misma plataforma.',
    'rows' => 'filas',
    'www' => 'www',
    'logo' => 'Logo',
    ...
    'pro_plan_feature4' => 'Eliminar "Creado por Africa Novatech"',
...
<li>Hoy es el viernes, la fecha límite es el primer viernes después. La fecha de vencimiento será el próximo viernes, no hoy.</li></ul>',
    ...
    'white_label_text' => 'Compra UN AÑO de Licencia de Marca Blanca por $:price y elimina la marca Africa Novatech de la Factura y del Portal de Cliente.',
    ...
    'pro_plan_remove_logo' => ':link haz click para eliminar el logo de Africa Novatech',
    ...
    'pro_plan_year_description' => 'Un año de inscripción en el Plan Africa Novatech Pro.',
    'pro_plan_month_description' => 'Un mes de inscripción en el Plan Africa Novatech Pro.',
    'enterprise_plan_product' => 'Plan Enterprise ',
    'enterprise_plan_year_description' => 'Un año de inscripción en el Plan Africa Novatech Enterprise .',
    'enterprise_plan_month_description' => 'Un mes de inscripción en el Plan Africa Novatech Enterprise .',
...
Una vez que tenga los montos, vuelva a esta página de métodos de pago y haga clic en "Verificación completa" junto a la cuenta.',
    ...
    'export_help' => 'Utilice JSON si planea importar los datos en  Africa Novatech.<br/>El fichero incluye clientes, productos, facturas, presupuestos y pagos.',
    ...
    'wepay_account_description' => 'Pasarela de Pago para Africa Novatech',
    ...
    'bot_get_email' => '¡Hola! (wave) <br/>Gracias por probar el Bot Africa Novatech. <br/>Necesitas crear una cuenta gratuita para usar este bot.<br/>Envíanme la dirección de correo electrónico de tu cuenta para comenzar.',
    ...
    'security_code_email_subject' => 'Código de seguridad para Africa Novatech Bot',
    'security_code_email_line1' => 'Este es su código de seguridad Africa Novatech Bot.',
    ...
    'update_invoiceninja_title' => 'Actualizar Africa Novatech',
    'update_invoiceninja_warning' => '¡Antes de comenzar a actualizar Africa Novatech cree una copia de seguridad de su base de datos y archivos!',
    'update_invoiceninja_available' => 'Está disponible una nueva versión de Africa Novatech.',
    'update_invoiceninja_unavailable' => 'No hay ninguna versión nueva de Africa Novatech.',
    ...
    'migrate_to_next_version' => 'Migrar a la siguiente versión de Africa Novatech',
    'migrate_intro_text' => 'Hemos estado trabajando en la siguiente versión de Africa Novatech. Pulsa en el botón de abajo para comenzar la migración.',
    'start_the_migration' => 'Empezar la migración',
    'migration' => 'Migración',
    'welcome_to_the_new_version' => 'Bienvenido a la nueva versión de Africa Novatech',
    ...
    'migration_went_wrong' => 'Uppps, ¡algo fue mal! Por favor, asegúrate de que has configurado una instancia Africa Novatech v5 antes de empezar la migración.',
    ...
    'welcome_to_invoice_ninja' => 'Bienvenid@ a Africa Novatech',
    'optin' => 'Optar en',
    'optout' => 'Optar por no',
    ...
    'complete' => 'Completar',
     ...
     'application_settings_label' => 'Vamos a guardar información básica acerca de tu Africa Novatech',
     ...
     'migration_api_secret_notice' => 'Puedes encontrar API_SECRET en el archivo .env o en Africa Novatech v5. Si no está presente, deja el campo vacío.',
    ...
    'migration_already_completed_desc' => 'Parece que ya ha migrado <b> :company_name </b>a la versión V5 de Africa Novatech. En caso de que desee comenzar de nuevo, puede forzar la migración para borrar los datos existentes.',
    ...
    'new_login_description' => 'Recientemente, inició sesión en su cuenta de Africa Novatech desde una nueva ubicación o dispositivo:<br><br><b>IP:</b> :ip<br><b>Time:</b> :time<br><b>Email:</b> :email',
    ...
    'stripe_connect_migration_desc' => 'Africa Novatech v5 utiliza Stripe Connect para vincular tu cuenta de Stripe con Africa Novatech. Esto ofrece una capa adicional de seguridad para tu cuenta. Ahora que tus datos se han migrado, necesitarás autorizar Stripe para aceptar pagos en v5.<br><br>Para ello accede a Ajustes > Pagos online > Configurar pasarela. Esto te llevará a la autorización de Africa Novatech en Stripe y al finalizar, tu cuenta estará correctamente vinculada.',
