...
$LANG = array(
    ...
    'pro_plan_success' => '¡Gracias por unirte a Africa Novatech! Al realizar el pago de tu factura, se iniciara tu Plan Pro !.<p/>&nbsp;<br/>
    ...
    'pro_plan_feature4' => 'Remueve "Creado por Africa Novatech"',
    ...
    'export_help' => 'Use JSON si planea importar la información en Africa Novatech.<br/>El archivo incluye clientes, productos, facturas, cotizaciones y pagos.',
    ...
    'bot_get_email' => 'Hola! (wave)<br/>Gracias por intentar usar el Bot de Africa Novatech<br/>Para poder usar este bot necesitas crear un cuenta gratuíta.<br/>Envíame la dirección de correo de tu cuenta para que empecemos.',
    ...
    'migrate_to_next_version' => 'Migrar a la próxima versión de Africa Novatech',
    'migrate_intro_text' => 'Hemos estado trabajando en la próxima versión de Africa Novatech. Haga clic en el botón de abajo para iniciar la migración.',
    ...
    'migration_went_wrong' => '¡Huy! Algo salió mal! Asegúrese de haber configurado una instancia de Africa Novatech v5 antes de iniciar la migración.',
    ...
    'complete' => 'Completo',
     ...
     'migration_api_secret_notice' => 'Puede encontrar API_SECRET en el archivo .env o en Africa Novatech v5. Si falta alguna propiedad, deje el campo en blanco.',
    ...
    'migration_already_completed_desc' => 'Parece que ya migró <b>:company_name</b> a la versión V5 de Africa Novatech. En caso de que desee comenzar de nuevo, puede forzar la migración para borrar los datos existentes.',
    ...
    'new_login_description' => 'Recientemente inició sesión en su cuenta de Africa Novatech desde una nueva ubicación o dispositivo:<br><br> <b>IP:</b> :ip<br> <b>Hora:</b> :time<br> <b>Correo electrónico:</b> :email',
